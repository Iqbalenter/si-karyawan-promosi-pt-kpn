...
const menuItems = [
  ...
  { path: '/perhitungan-saw', label: 'Perhitungan SAW', icon: Calculator },
  { path: '/hasil-ranking', label: 'Hasil Ranking', icon: Award },
];
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 p-6">
        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#FFB703] text-2xl font-bold text-[#1B4332]">K</div>
      ...
      <div className="border-t border-[#40916C] p-6">
        <div className="flex items-center justify-between mb-4 text-xs opacity-80 hover:opacity-100 transition-opacity cursor-pointer">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold">Admin Utama</p>
              <p className="text-[10px]">Administrator System</p>
            </div>
          </div>
        </div>
        <button 
